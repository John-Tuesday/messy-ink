...
internal fun buildM3ColorScheme(
    ...
    return ColorScheme(
        ...
        surfaceDim = neutral.withLabL(if (isLight) 87 else 6),
        surfaceBright = neutral.withLabL(if (isLight) 98 else 24),
        surfaceContainerLowest = neutral.withLabL(if (isLight) 100 else 4),
        surfaceContainerLow = neutral.withLabL(if (isLight) 96 else 10),
        surfaceContainer = neutral.withLabL(if (isLight) 94 else 12),
        surfaceContainerHigh = neutral.withLabL(if (isLight) 92 else 17),
        surfaceContainerHighest = neutral.withLabL(if (isLight) 90 else 22),

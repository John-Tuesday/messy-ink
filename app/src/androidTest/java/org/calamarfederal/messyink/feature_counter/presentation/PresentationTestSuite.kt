...
import org.calamarfederal.messyink.feature_counter.presentation.counter_history.CounterHistoryScreenshots
...
import org.calamarfederal.messyink.feature_counter.presentation.counter_overview.CounterOverviewScreenshot
...
import org.calamarfederal.messyink.feature_counter.presentation.game_counter.GameCounterScreenshot
...
@RunWith(Suite::class)
@SuiteClasses(
    CounterOverviewScreenshot::class,
    GameCounterScreenshot::class,
    CounterHistoryScreenshots::class,
)
class PresentationScreenshots
